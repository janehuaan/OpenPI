...
export interface MemoryConfig {
	...
	/** Retention for auto session digests. 0 disables expiry. */
	sessionDigestRetentionDays: number;
	/** Retention for heuristic WIP project notes. 0 disables expiry. */
...
export const DEFAULT_MEMORY_CONFIG: MemoryConfig = {
	...
	softDelete: true,
	searchArchive: true,
	archiveSearchLimit: 10000,
	archiveSearchMinScore: 0.2,
