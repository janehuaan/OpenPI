/**
 * Minimal SVG icon components to replace lucide-react (~29 MB).
...
export const Bell = (props: SVGProps<SVGSVGElement>) => (
	<Icon {...props}>
		<path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9M10.5 21a1.5 1.5 0 0 0 3 0" />
	</Icon>
);
// Check
...
export const BrainCircuit = (props: SVGProps<SVGSVGElement>) => (
	<Icon {...props}>
		...
		<path d="M12 5a3 3 0 1 1 5.997.705A2.004 2.004 0 0 0 19 7.5c0 1.037-.778 1.895-1.775 1.988A3.001 3.001 0 0 1 15 12.003V14" />
		<path d="M7.5 15.5h9" />
		<path d="M8 20h8" />
		<path d="M12 14v1.5" />
	</Icon>
