...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "Web Fetch",
		description:
			"Fetch the text content of a web page. Use this when you need to read documentation, search for solutions, or get information from the internet. Only works with http/https URLs.",
		promptSnippet: "Use web_fetch to retrieve and read web page content from a given URL",
