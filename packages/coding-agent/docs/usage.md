...
Built-in workflows include MCP, sub-agents, permission popups, plan mode, to-dos, and background bash. You can still replace or extend them with extensions, packages, or external tools such as containers and tmux.
